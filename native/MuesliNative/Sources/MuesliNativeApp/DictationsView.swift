...
struct DictationsView: View {
    ...
    private var bridgeTitle: String {
        ...
        case .notConfigured:
            return "Use \(AppIdentity.displayName) on iPhone"
        }
    }
    ...
    private var bridgeSubtitle: String {
        ...
        case .notConfigured:
            return "Your \(AppIdentity.displayName) history follows you through private iCloud. Audio stays local."
        }
    }
        ...
        VStack(alignment: .leading, spacing: MuesliTheme.spacing16) {
            HStack(alignment: .top) {
                VStack(alignment: .leading, spacing: MuesliTheme.spacing4) {
                    Text("Open \(AppIdentity.displayName) on iPhone")
                        .font(MuesliTheme.title3())
                        .foregroundStyle(MuesliTheme.textPrimary)
