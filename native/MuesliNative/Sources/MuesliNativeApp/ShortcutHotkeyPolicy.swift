...
struct ShortcutHotkeyPolicy {
    ...
    static let commonGlobalShortcutWarning = "This shortcut is commonly used by other apps. \(AppIdentity.displayName) listens globally, so choose a less common combination if it conflicts with your workflow."
